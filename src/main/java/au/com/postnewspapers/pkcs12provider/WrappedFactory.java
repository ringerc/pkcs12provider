...
/**
 * Code shamelessly lifted from the PostgreSQL JDBC driver's
...
* Extensions copyright (c) 2010 Craig Ringer <craig@postnewspapers.com.au>
* (Craig Ringer licenses all changes to this file under the original PgJDBC license)
*
* IDENTIFICATION
